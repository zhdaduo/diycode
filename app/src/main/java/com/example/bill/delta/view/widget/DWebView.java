...
import com.example.bill.delta.util.AppOperator;
import com.example.bill.delta.util.LogUtil;
import com.example.bill.delta.view.activity.ImageActivity;
...
public class DWebView extends WebView {
  ...
  public void loadDetailDataAsync(final String content, Runnable finishCallback) {
    ...
    if (context != null && context instanceof Activity) {
      ...
      LogUtil.e(TAG, "loadDetailDataAsync error, the Context isn't ok");
    }
  }
