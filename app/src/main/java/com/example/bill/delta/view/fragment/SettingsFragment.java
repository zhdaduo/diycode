package com.example.bill.delta.view.fragment;
...
public class SettingsFragment extends PreferenceFragment {
  ...
  private void addSignOut() {
    //context.getResources().getString(R.string.pref_key_sign_out)
    Preference myPref = findPreference("pref_key_sign_out");
    myPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
      public boolean onPreferenceClick(Preference preference) {
        //context.getResources().getString(R.string.logout_intent_action)
        Intent intent = new Intent("com.plusend.diycode.Logout");
  ...
  private void addCheckUpdate() {
    //context.getResources().getString(R.string.pref_key_check_update)
    Preference myPref = findPreference("pref_key_check_update");
    myPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
      public boolean onPreferenceClick(Preference preference) {
  ...
  private void addFeedback() {
    //context.getResources().getString(R.string.pref_key_feedback)
    Preference myPref = findPreference("pref_key_feedback");
    myPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
      public boolean onPreferenceClick(Preference preference) {
  ...
  void checkUpdate() {
    ...
    //context.getResources().getString(R.string.file_provider)
    PgyUpdateManager.register(getActivity(), "com.pgyersdk.provider",
  ...
  void showDeniedForWriteExteralStorage() {
    showToastMessage("您已经拒绝了使用存储空间/电话/麦克风权限中的一项或全部");
  }
  ...
  //fixed bug : android.content.Context.getResources() on a null object reference
  @Override
