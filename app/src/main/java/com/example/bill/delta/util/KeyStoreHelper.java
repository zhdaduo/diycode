...
public class KeyStoreHelper {
    ...
    private static void createKeysJBMR2(Context context, String alias)
        ...
        LogUtil.d(TAG, "Public Key is: " + kp.getPublic().toString());
    }
    ...
    private static void createKeysM(String alias, boolean requireAuth)
        ...
        LogUtil.d(TAG, "Public Key is: " + keyPair.getPublic().toString());
    }
    ...
    private static KeyStore.PrivateKeyEntry getPrivateKeyEntry(String alias)
        ...
        if (entry == null) {
            LogUtil.w(TAG, "No key found under alias: " + alias);
            return null;
        }

        if (!(entry instanceof KeyStore.PrivateKeyEntry)) {
            LogUtil.w(TAG, "Not an instance of a PrivateKeyEntry");
            return null;
        }
